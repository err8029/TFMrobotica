...
pos.names = getImageSet('data/images_train/pos') ;
pos.histograms = computeHistogramsFromImageList(vocabulary, pos.names, 'data/cache') ;
neg.names = getImageSet('data/images_train/neg') ;
neg.histograms = computeHistogramsFromImageList(vocabulary, neg.names, 'data/cache') ;

%add all images and label them
...
% Load testing data
pos.names = getImageSet('data/images_test/pos') ;
pos.histograms = computeHistogramsFromImageList(vocabulary, pos.names, 'data/cache') ;
neg.names = getImageSet('data/images_test/neg') ;
neg.histograms = computeHistogramsFromImageList(vocabulary, neg.names, 'data/cache') ;
