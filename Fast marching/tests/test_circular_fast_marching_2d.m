...
M = rgb2gray(M);%conver image to grayscale
M = rescale(M);
m = size(M);

imshow(M)

addpath('/home/eric/Escritorio/tfm_practico/Fast marching')%add toolbox functions
addpath('/home/eric/Escritorio/tfm_practico/Fast marching/toolbox')
