classdef TurtleBotVisualizer < handle
    ...
    methods (Access = public)
        function obj = TurtleBotVisualizer(ranges)
            %ExampleHelperTurtleBotVisualizer - Constructor sets all the figure propertie
            obj.FigureHandle = figure('Name','Robot Position','CloseRequestFcn',@obj.closeFigure);
            obj.AxesHandle = axes('XGrid','on','YGrid','on','XLimMode','manual','YLimMode','manual','unit', 'normalized', 'position', [0.1 0.1 0.8 0.8]);
